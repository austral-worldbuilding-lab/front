import {Character, Postit, MandalaImage} from "@/types/mandala";
...
export const shouldShowImage = (image: MandalaImage, appliedFilters: Record<string, string[]>): boolean => {
    if (!image) return false;
    const { dimension, section, tags } = image;
