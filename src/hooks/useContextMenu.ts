...
export function useContextMenu(
    ...
    const showContextMenu = (e: KonvaEventObject<PointerEvent>, index: number, type: ContextMenuType) => {
    ...
    const hideContextMenu = () => {
        setContextMenu({ visible: false, x: 0, y: 0, postItIndex: null, characterIndex: null, type: null });
    };
        ...
        if (contextMenu.postItIndex !== null) {
            try {
                ...
                if (success) {
                    ...
                    } else if (editableIndex !== null && editableIndex > contextMenu.postItIndex) {
