...
const CharacterItem: React.FC<CharacterItemProps> = ({ character, onAdd }) => {
    ...
    const goToMandala = () => {
        // Reemplaza SOLO el segmento mandala/<id> y preserva ?trail=...
        const nextPath = pathname.replace(/(mandala\/)[^/?#]+/, `$1${character.id}`);
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3">
                <div className="w-4 h-4 rounded-full" style={{ backgroundColor: character.color }} />
