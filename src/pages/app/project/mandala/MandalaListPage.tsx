  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start pt-12">
      <div className="w-full max-w-2xl px-4">
        <h1 className="text-2xl font-bold mb-6 text-center">Mandalas del Proyecto</h1>
        <div className="bg-white rounded-lg shadow-sm border">
          {mandalas.length === 0 ? (
            <p className="p-4 text-gray-600 text-center">No hay mandalas creadas aún.</p>
          ) : (
              ...
              {mandalas.map((mandala) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="flex-1">{mandala.name || "Mandala sin nombre"}</span>
                  </Link>
                </li>
              ))}
            </ul>
