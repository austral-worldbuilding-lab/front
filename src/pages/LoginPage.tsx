...
const LoginPage = () => {
    ...
    const firebaseErrorMap: Record<string, string> = {
        ...
        "auth/invalid-credential": "No existe un usuario con ese correo.",
            ...
            <div className={'flex flex-row gap-8 w-5/10 p-10 bg-background'}>
                ...
                <div className={'w-1/2 p-4 flex flex-col gap-4'}>
                    <CustomInput
                        ...
                        error={error?.includes("auth/invalid-email") ? "Correo electrónico inválido" : undefined}
                    />
                    <CustomInput
                        ...
                        error={error?.includes("auth/wrong-password") ? "Contraseña incorrecta" : undefined}
                    />
                    ...
                    {error &&
                        ...
                        !error.includes("auth/wrong-password") && (
                            <p className="text-red-500 text-sm">{getMessageFromErrorCode(error)}</p>
                        )}
